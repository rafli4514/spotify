	...
	return (
		<Dialog open={albumDialogOpen} onOpenChange={setAlbumDialogOpen}>
			...
			<DialogContent className='bg-zinc-900 border-zinc-700'>
				<DialogHeader>
					<DialogTitle>Tambahkan album Baru</DialogTitle>
					<DialogDescription>Menambahkan album baru ke koleksi Anda</DialogDescription>
				</DialogHeader>
					...
					>
						<div className='text-center'>
							...
							<div className='text-sm text-zinc-400 mb-2'>
								{imageFile ? imageFile.name : "Upload artwork album"}
							</div>
